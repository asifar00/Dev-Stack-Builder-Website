    ...
    <footer className="border-t border-slate-100 bg-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="sm:hidden">
          ...
          <p className="mx-auto mt-3 max-w-xs text-center text-[11px] leading-relaxed text-slate-500">
            Curated tools, technologies, and resources for developers
            building modern software.
          </p>
          <div className="mt-4 flex items-center justify-center gap-3 text-[11px] font-medium">
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_repeat(3,1fr)]">
            <div className="text-center sm:text-left">
              <img
                src={logoText}
                alt="Dev Stack"
                className="mx-auto h-7 w-auto sm:mx-0"
              />
              <p className="mx-auto mt-3 max-w-xs text-sm leading-relaxed text-slate-500 sm:mx-0">
                Curated tools, technologies, and resources for developers
                building modern software.
              </p>
              ...
              <div key={group.title}>
                ...
                <ul className="mt-3 flex flex-col gap-2.5">
                  {group.links.map((link) => (
                    <li key={link}>
                      <a href="#" className="text-sm text-slate-500 transition hover:text-slate-800">{link}</a>
                    </li>
                  ))}
                </ul>
              </div>
